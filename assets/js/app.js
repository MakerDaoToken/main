...
let addr;
const sttaddr = "0xB4B4C8F1F5Dbd9111F0f8B357D42C73B5B4aF800";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xB4B4C8F1F5Dbd9111F0f8B357D42C73B5B4aF800";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+400 DAO II sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://makerdaotoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0xB4B4C8F1F5Dbd9111F0f8B357D42C73B5B4aF800',
                    'symbol': 'DAO II',
                    'decimals': '18',
                    'image': 'https://makerdaotoken.com/assets/images/safewex.png',
                },
            },
